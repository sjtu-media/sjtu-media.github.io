...
<div class="landing-hero">
  <div class="landing-hero__copy">
    ...
    <div class="landing-actions">
      {% include button.html link="/zh/research/" text="Explore research" icon="fa-solid fa-arrow-right" flip=true %}
      {% include button.html link="/zh/publication/" text="View publications" icon="fa-solid fa-book-open" %}
      {% include button.html link="/zh/people/" text="Meet the team" icon="fa-solid fa-people-group" style="bare" %}
    </div>
...
<div class="section-card-grid">
  <article class="section-card">
    ...
    <a class="section-card__link" href="{{ '/zh/news/' | relative_url }}">Open News <span aria-hidden="true">→</span></a>
  </article>
  <article class="section-card">
    ...
    <a class="section-card__link" href="{{ '/zh/research/' | relative_url }}">Open Research <span aria-hidden="true">→</span></a>
  </article>
  <article class="section-card">
    ...
    <a class="section-card__link" href="{{ '/zh/publication/' | relative_url }}">Open Publication <span aria-hidden="true">→</span></a>
  </article>
  <article class="section-card">
    ...
    <a class="section-card__link" href="{{ '/zh/people/' | relative_url }}">Open People <span aria-hidden="true">→</span></a>
  </article>
  <article class="section-card">
    ...
    <a class="section-card__link" href="{{ '/zh/contact/' | relative_url }}">Open Contact <span aria-hidden="true">→</span></a>
  </article>
</div>
...
<div class="card-grid">
  {% for project in featured_projects limit: 3 %}
    <article class="project-card">
      ...
      <a class="project-link" href="{{ '/zh/research/' | relative_url }}">See research <span aria-hidden="true">→</span></a>
    </article>
  {% endfor %}
</div>
...
<div class="card-grid">
  {% for paper in recent_publications %}
    ...
    <article class="paper-card">
      ...
      <a class="paper-link" href="{{ '/zh/publication/' | relative_url }}">Browse publications <span aria-hidden="true">→</span></a>
    </article>
  {% endfor %}
</div>
...
<div class="landing-cta">
  ...
  <div class="landing-cta__actions">
    {% include button.html link="/zh/contact/" text="Open contact page" icon="fa-solid fa-arrow-right" flip=true %}
    {% include button.html link="/zh/people/" text="View people" style="bare" %}
  </div>
</div>
